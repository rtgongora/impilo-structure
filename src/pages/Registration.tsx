...
import { UserPlus, Calendar, Shield, ArrowLeft, Users, Fingerprint, FileCheck } from "lucide-react";
...
export default function Registration() {
  ...
  const menuItems = [
    { id: "registration", icon: UserPlus, title: "New Client Registration", description: "Register a new patient with demographics, biometrics, and consent", color: "bg-primary", features: ["Demographics", "Biometric ID", "FHIR Consent"] },
  ...
  return (
    <AppLayout title="Patient Registration & Identity">
      <div className="p-6">
